            ...
            <div className="flex mf:flex-row flex-col items-start justify-between md:p-20 py-12 px-4">
                <div className="flex flex-1 justify-start items-start flex-col mf:mr-10">
                    ...
                    <p className="text-left mt-5 text-white font-light md:w-9/12 w-11/12 text-base">
                        Explore the crypto world. Buy and sell cryptocurrencies easily on Senbuys.
                    </p>
                    {!currentAccount && (
                        <button
                            type="button"
                ...
                <div className="flex flex-col flex-1 items-center justify-start w-full mf:mt-0 mt-10">
                    ...
                    <div className="p-5 sm:w-96 w-full flex flex-col justify-start justify-center blue-glassmorphism">
                        ...
                        <Input placeholder="Keyword (Gif)" name="kayword" type="number" handleChange={handleChange} />
